...
public interface UserService {
	...
	Map<Feedback.Key, Object> addNewComment(int currentUserId, String alienId, String newComment) throws ServiceException;
	...
	Map<Key, Object> updateImage(String serverDeploymentPath, String rootFolder, Part userImage, int userId,
