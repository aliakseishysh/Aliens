...
<c:set var="UPDATE_USER_INFO" scope="session" value="${CommandValue.UPDATE_USER_INFO.getValue()}"/>
...
<c:set var="FORGOT_PASSWORD" scope="session" value="${CommandValue.FORGOT_PASSWORD.getValue()}"/>
