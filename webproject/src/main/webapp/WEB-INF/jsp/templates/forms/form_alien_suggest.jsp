	...
	<form id="form-alien-suggest" enctype="multipart/form-data" class="needs-validation" novalidate> 
		<fieldset class="form-group">
			<legend class="border-bottom mb-4">${TEXT[FORM_ALIEN_SUGGEST_LEGEND]}</legend>
   			<label class="control-label col-sm-2" for="form-alien-suggest-name">${TEXT[FORM_ALIEN_CREATE_NAME]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-2" for="form-alien-suggest-description-small">${TEXT[FORM_ALIEN_CREATE_SMALL_DESCRIPTION]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-2" for="form-alien-suggest-description-full">${TEXT[FORM_ALIEN_CREATE_FULL_DESCRIPTION]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-2" for="form-alien-suggest-image">${TEXT[FORM_ALIEN_CREATE_IMAGE]}</label>
   			<div class ="col-sm-10">
	   			<div class="custom-file">
	  				<input type="file" class="custom-file-input form-control-file" id="form-alien-suggest-image" required>
