...
/**
 * Enum {@code LocaleKey} designed for storing information about localization
 * keys
 * 
...
public enum LocaleKey implements EnumValue {
	...
	// Suggest alien
	PAGE_SUGGEST_ALIEN_TITLE("page_suggest_alien_title"), PAGE_SUGGEST_ALIEN_H1("page_suggest_alien_h1"),
	PAGE_SUGGEST_ALIEN_SUBMIT("page_suggest_alien_submit"),
	// Alien profile page
	PAGE_ALIEN_PROFILE_TITLE("page_alien_profile_title"), PAGE_ALIEN_PROFILE_H1("page_alien_profile_h1"),
	...
	// Banned Page
	PAGE_BANNED_TITLE("page_banned_title"), PAGE_BANNED_H1("page_banned_h1"), PAGE_BANNED_H2("page_banned_h2"),
	// Home page
	PAGE_HOME_TITLE("page_home_title"), PAGE_HOME_H1("page_home_h1"), PAGE_HOME_ALIENBAR("page_home_alienbar"),
	PAGE_HOME_CONTACT_ADMIN("page_home_contact_admin"), PAGE_HOME_ADMIN_EMAIL("page_home_admin_email"),
	PAGE_HOME_YEAR("page_home_year"),
	// Login page
	PAGE_LOGIN_TITLE("page_login_title"), PAGE_LOGIN_H1("page_login_h1"),
	// Profile page
	PAGE_PROFILE_TITLE("page_profile_title"), PAGE_PROFILE_UNKNOWN_ROLE("page_profile_unknown_role"),
	// Register page
	PAGE_REGISTER_TITLE("page_register_title"), PAGE_REGISTER_H1("page_register_h1"),
	// Admin page
	PAGE_ADMIN("page_admin_title"), PAGE_ADMIN_H1("page_admin_h1"),
	...
	FORM_ALIEN_CREATE_LEGEND("form_alien_create_legend"), FORM_ALIEN_CREATE_NAME("form_alien_create_name"),
	...
	FORM_ALIEN_CREATE_IMAGE("form_alien_create_image"), FORM_ALIEN_CREATE_IMAGE_LABEL("form_alien_create_image_label"),
	FORM_ALIEN_CREATE_SUBMIT("form_alien_create_submit"),
	// Form alien update
	FORM_ALIEN_UPDATE_LEGEND("form_alien_update_legend"), FORM_ALIEN_UPDATE_NAME("form_alien_update_name"),
	...
	FORM_ALIEN_UPDATE_IMAGE("form_alien_update_image"), FORM_ALIEN_UPDATE_IMAGE_LABEL("form_alien_update_image_label"),
	FORM_ALIEN_UPDATE_SUBMIT("form_alien_update_submit"),
	// Form user ban unban
	FORM_USER_BAN_UNBAN_LEGEND("form_user_ban_unban_legend"), FORM_USER_BAN_UNBAN_LOGIN("form_user_ban_unban_login"),
	...
	// Form email update
	FORM_EMAIL_UPDATE_LEGEND("form_email_update_legend"), FORM_EMAIL_UPDATE_EMAIL("form_email_update_email"),
	FORM_EMAIL_UPDATE_EMAIL_PLACEHOLDER("form_email_update_email_placeholder"),
	FORM_EMAIL_UPDATE_SUBMIT("form_email_update_submit"),
	// Form image update
	FORM_IMAGE_UPDATE_LEGEND("form_image_update_legend"), FORM_IMAGE_UPDATE_IMAGE("form_image_update_image"),
	FORM_IMAGE_UPDATE_IMAGE_LABEL("form_image_update_image_label"),
	FORM_IMAGE_UPDATE_SUBMIT("form_image_update_submit"),
	// Form login update
	FORM_LOGIN_UPDATE_LEGEND("form_login_update_legend"), FORM_LOGIN_UPDATE_LOGIN("form_login_update_login"),
	FORM_LOGIN_UPDATE_LOGIN_PLACEHOLDER("form_login_update_login_placeholder"),
	FORM_LOGIN_UPDATE_SUBMIT("form_login_update_submit"),
	// Form login
	FORM_LOGIN_LEGEND("form_login_legend"), FORM_LOGIN_EMAIL("form_login_email"),
	FORM_LOGIN_PLACEHOLDER("form_login_placeholder"), FORM_LOGIN_PASSWORD("form_login_password"),
	FORM_LOGIN_PASSWORD_PLACEHOLDER("form_login_password_placeholder"), FORM_LOGIN_SUBMIT("form_login_submit"),
	FORM_LOGIN_NEED_AN_ACCOUNT("form_login_need_an_account"), FORM_LOGIN_SIGN_UP_NOW("form_login_sign_up_now"),
	// Form new comment
	FORM_NEW_COMMENT_LEGEND("form_new_comment_legend"), FORM_NEW_COMMENT_LABEL("form_new_comment_label"),
	FORM_NEW_COMMENT_PLACEHOLDER("form_new_comment_placeholder"), FORM_NEW_COMMENT_SUBMIT("form_new_comment_submit"),
	...
	// form register
	FORM_REGISTER_LEGEND("form_register_legend"), FORM_REGISTER_EMAIL_LABEL("form_register_email_label"),
	...
	// feedback
	STANDARD_EMAIL_FEEDBACK("standard_email_feedback"), STANDARD_LOGIN_FEEDBACK("standard_login_feedback"),
	...
	STANDARD_IMAGE_FEEDBACK("standard_image_feedback"), STANDARD_DAYS_TO_BAN_FEEDBACK("standard_days_to_ban_feedback"),
	...
	NO_USER_WITH_EMAIL("no_user_with_email"), EMAIL_FEEDBACK_INVALID("email_feedback_invalid"),
	...
	// email
	EMAIL_SUBJECT_REGISTER("email_subject_register"), EMAIL_SUBJECT_CHANGE_EMAIL("email_subject_change_email"),
	EMAIL_CONTENT_REGISTER("email_content_register"), EMAIL_CONTENT_CHANGE_EMAIL("email_content_change_email"),
	CHECK_YOUR_EMAIL("check_your_email"),

	// error pages
	ERROR_PAGE("error_page"), ERROR_PAGE_400("error_page_400"),
	ERROR_PAGE_400_BAD_REQUEST("error_page_400_bad_request"), ERROR_PAGE_403("error_page_403"),
	ERROR_PAGE_403_FORBIDDEN("error_page_403_forbidden"), ERROR_PAGE_404("error_page_404"),
	ERROR_PAGE_404_NOT_FOUND("error_page_404_not_found"), ERROR_PAGE_500("error_page_500"),
