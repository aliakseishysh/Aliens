...
import static by.shyshaliaksey.aliens.model.connection.DatabasePropertiesReader.CONNECTION_POOL_DEFAULT_SIZE;
...
public class ConnectionPool {
	 ...
	 * @return {@code true} if connection closed, {@code false} otherwise
	 */
	...
	public void destroyConnectionPool() {
		...
		deregisterDrivers();
		logger.log(Level.INFO, "Connection pool destroyed");
	}
