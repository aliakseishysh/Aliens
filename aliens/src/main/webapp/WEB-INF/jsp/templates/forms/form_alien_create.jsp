	...
	<form id="form-alien-create" enctype="multipart/form-data" class="needs-validation" novalidate> 
		<fieldset class="form-group">
			<legend class="border-bottom mb-4">${TEXT[FORM_ALIEN_CREATE_LEGEND]}</legend>
   			<label class="control-label col-sm-10" for="form-alien-create-name">${TEXT[FORM_ALIEN_CREATE_NAME]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-10" for="form-alien-create-description-small">${TEXT[FORM_ALIEN_CREATE_SMALL_DESCRIPTION]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-10" for="form-alien-create-description-full">${TEXT[FORM_ALIEN_CREATE_FULL_DESCRIPTION]}</label>
			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-10" for="form-alien-create-image">${TEXT[FORM_ALIEN_CREATE_IMAGE]}</label>
   			<div class ="col-sm-10">
	   			<div class="custom-file">
	  				<input type="file" class="custom-file-input form-control-file" id="form-alien-create-image" lang="${CURRENT_LOCALE_ABBREVIATION}" required>
