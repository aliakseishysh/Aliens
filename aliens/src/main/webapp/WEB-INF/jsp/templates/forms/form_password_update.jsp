	...
	<form id="form-update-password" class="needs-validation" novalidate>
		<fieldset class="form-group">
			<legend class="border-bottom mb-4">${TEXT[FORM_PASSWORD_UPDATE_LEGEND]}</legend>
   			<label class="control-label col-sm-10" for="form-update-password-password">${TEXT[FORM_PASSWORD_UPDATE_PASSWORD_LABEL]}</label>
   			<div class="col-sm-10">
   			...
   			<label class="control-label col-sm-10" for="form-update-password-password-confirmation">${TEXT[FORM_PASSWORD_UPDATE_PASSWORD_CONFIRMATION_LABEL]}</label>
   			<div class="col-sm-10">
